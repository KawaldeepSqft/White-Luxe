            ...
            >
              <Link to={property.path}>
                ...
                <div className="absolute bottom-0 w-full text-white p-6 bg-gradient-to-t from-black via-black/70 to-transparent">
                  ...
                  <button className="mt-4 bg-gradient-to-r from-[#D7AE29] to-[#FFF389] hover:opacity-90 text-[#333] text-sm font-medium px-5 py-2 rounded-full shadow-md transition">
                    View Details
                  </button>
                </div>
              </Link>
